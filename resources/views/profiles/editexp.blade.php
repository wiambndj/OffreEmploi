...
<section class="bg-half page-next-level"> 
    ...
    <div class="section-title text-center mb-4 pb-2">
                        <h4 class="title title-line pb-5">Modifier experience</h4>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <form action="{{ url('exp/'.$experience->id) }}" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_method" value="PUT">
                {{ csrf_field() }}

          <div class="form-group">
          <label for="">Intitule</label>
          <input type="text" name="intitule" class="form-control" value="{{ $experience->intitule }}">
          </div>
          ...
          <div class="form-group">
			 ...
			 <input type="text" name="lieu" class="form-control" value="{{ $experience->lieu }}">
			</div>

			<div class="form-group">
			 <label for="datedebut">Date debut</label>
			 <input type="date" name="debut" class="form-control" value="{{ $experience->debut }}" >
			</div>

			<div class="form-group">
			 <label for="datefin">Date fin</label>
			 <input type="date" name="fin" class="form-control" value="{{ $experience->fin }}">
			</div>
